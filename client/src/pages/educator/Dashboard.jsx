    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-8">
      <div className="space-y-5">
        ...
        <div className="pb-4 text-lg font-medium">
          ...
          <div className="flex flex-col items-center max-w-4xl w-fukk overflow-hidden rounded-md bg-white border border-gray-500/20">
          <table className="table-fixed md:table-auto w-full overflow-hiden">
